...
# MODIFIED: Remove caching for better GitHub sync
def load_signals():
...
def main():
  ...
  with placeholder.container():
      ...
      # MODIFIED: Reduced timeout for GitHub sync (30 seconds instead of 120)
      is_connected = False
      connection_source = ""
      ...
      if status and 'timestamp' in status:
          try:
              ...
              if time_diff < 30:  # MODIFIED: Reduced from 120 to 30
                  is_connected = True
      ...
      if not status:
          ...
          """, unsafe_allow_html=True)
          time.sleep(3)  # MODIFIED: Reduced from 5 to 3 seconds
          st.rerun()
          return
  ...
  # Auto-refresh - MODIFIED: Faster refresh for GitHub sync
